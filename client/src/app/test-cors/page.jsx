  ...
  return (
    <div className="min-h-screen p-8 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-8">CORS Connection Test</h1>
        ...
        <div className="glass p-6 rounded-lg mb-6">
          ...
          {response && (
            <div className="bg-green-500/20 border border-green-500/50 p-4 rounded-lg">
              <h3 className="text-green-400 font-semibold mb-2">Server Response:</h3>
        ...
        <div className="glass p-6 rounded-lg">
          <h2 className="text-2xl font-semibold text-white mb-4">CORS Configuration Info</h2>
          <div className="text-gray-300 space-y-2">
            <p><strong>Client URL:</strong> http://localhost:3000</p>
            <p><strong>Server URL:</strong> http://localhost:5000</p>
            <p><strong>Credentials:</strong> Enabled</p>
            <p><strong>Methods:</strong> GET, POST, PUT, DELETE, OPTIONS, PATCH</p>
            <p><strong>Headers:</strong> Authorization, Content-Type, and more</p>
          </div>
        </div>
      </div>
    </div>
